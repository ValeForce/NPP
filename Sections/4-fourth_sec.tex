...
\item Studiando la distribuione angolare dei prodotti di decadimenti si trova che lo spin del $\Delta$ è $3/2$. Per $\sqrt s<1.4$ GeV le sezioni d'urto elastica e totale coincidono.
\end{itemize}
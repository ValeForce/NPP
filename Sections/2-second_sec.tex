...
\begin{itemize}
    \item Gli antiprotoni sono più difficili da rivelare rispetto ai positroni perché avranno una massa pari a quella del protone e quindi sono più difficile da produrre. Ovviamente ce li aspettiamo con carica negativa.
...
Bisogna fare attenzione a non confondere acceleratori circolari, in cui il target è comunque fisso, con collider.
\begin{itemize}
...
\begin{itemize}
    ...
    \begin{equation*}
    \tan \vartheta=\frac{\sin\vartheta^*}{\gamma\qty(\frac\beta{\beta^*}+\cos\vartheta^*)}
    \end{equation*}
    con $\beta^*=p^*/E^*$.
...
\begin{itemize}
    ...
    \begin{equation*}
        m=\sum_{i=1}^nE_i^*=\sum_i\sqrt{p_i^2+m_i^2}\geq\sum_i m_i\implies m\geq\sum_i m_i
    \end{equation*}
...
\begin{itemize}
    ...
    \begin{equation*}
        ...
        \end{equation*}
        Si ha il valore di $\vartheta$ minimo quando il denominatore è massimo. Troviamo i valori per cui è massimo:
        \begin{equation*}

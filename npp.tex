...
\import{./Sections}{6-sixth_sec.tex}
...
\begin{itemize}
    ...
    \item Allo SLAC avevano energia fino a 25 GeV (prima gen), la seconda generazione negli anni 80 al CERN con fasci di muoni fino a 300 GeV (per produrre muoni si usano protoni di 400 GeV \textbf{credo} che colpiscono target producendo pioni che poi decadoni in muoni che raccogliamo e abbiamo il fascio di 300 GeV), infine DESY in Germania con il collider $ep$ (asimmetrico) HERA fino al 2007, con elettroni di 30 GeV e protoni di 900 GeV.
\end{itemize}
\section{Esercizi}
